...
},beforePageText:"P&aacute;gina",afterPageText:"de {pages}",displayMsg:"Exibindo {from} at&eacute; {to} de {total} itens",nav:{first:{iconCls:"pagination-first",handler:function(){
