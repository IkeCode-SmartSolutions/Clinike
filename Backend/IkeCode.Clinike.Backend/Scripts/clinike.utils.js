        ...
        load: function (options) {
            ...
            if (!isValid) {
                ...
                var parsedQueryParams = function (params) {
                    ...
                    if (parsedOpt.customQueryParams !== undefined && parsedOpt.customQueryParams != null && $.isPlainObject(parsedOpt.customQueryParams) && !$.isEmptyObject(parsedOpt.customQueryParams)) {
                        parsedParams = $.extend(true, {}, parsedParams, parsedOpt.customQueryParams);
                    }
