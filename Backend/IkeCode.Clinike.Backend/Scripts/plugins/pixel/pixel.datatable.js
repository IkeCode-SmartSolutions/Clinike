...
(/** @lends <global> */function (window, document, undefined) {
    ...
    (/** @lends <global> */function ($) {
        ...
        function _fnGetObjectDataFn(mSource) {
            //console.log('_fnGetObjectDataFn mSource', mSource);
            //console.log('_fnGetObjectDataFn mSource TYPE', $.type(mSource));
            if ($.isPlainObject(mSource)) {
                ...
                return function (data, type, extra) {
                    //console.log('_fnGetObjectDataFn function data', data);
                    //console.log('_fnGetObjectDataFn function type', type);
                    //console.log('_fnGetObjectDataFn function extra', extra);
        ...
        */
        ...
        function _fnAjaxDataSrc(oSettings, json) {
            //console.log('_fnAjaxDataSrc oSettings', oSettings);
            //console.log('_fnAjaxDataSrc json', json);
            var dataSrc = $.isPlainObject(oSettings.ajax) && oSettings.ajax.dataSrc !== undefined ?
                oSettings.ajax.dataSrc :
                oSettings.sAjaxDataProp; // Compatibility with 1.9-.
            // Compatibility with 1.9-. In order to read from aaData, check if the
            // default has been changed, if not, check for aaData
            //console.log('_fnAjaxDataSrc dataSrc', dataSrc);
            //console.log('_fnAjaxDataSrc json.aaData', json.aaData);
            //console.log('_fnAjaxDataSrc json[dataSrc]', json[dataSrc]);
            if (dataSrc === 'data') {
